...
@Composable
fun PendingTakeOverRequest(
    modifier: Modifier = Modifier,
    viewModel: SickLeaveViewModel
) {
    ...
    Column(
        ...
        SwipeRefresh(
            ...
            if (viewModel.takeoverLeave.isEmpty() && !isRefreshing) {
                Text("No leave requests found", modifier = Modifier.fillMaxWidth(), textAlign = TextAlign.Center)
            } else {
                LazyColumn {
